...
using the ancient formula passed down through generations. (2 * n!, though this was a secret, untill...)
...
An old wise man has come to you, and said; that the Trial of Recursion is 2 * n! : Now you may become a Sage.
BEWARE, THE OLD MAN'S ADVICE IS TRUTHFUL!
*/

public class TrialOfRecursion {
    ...
    public static void main(String[] args) {
        System.out.println(factorial(5));  // Expected: 240
    }
}
